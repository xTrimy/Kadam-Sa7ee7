            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between p-6 bg-white border-b border-gray-200">
                    <h1 class="text-xl">
                        ...
                        {{ __('Total Count') }} : {{ $supplies->count() }}
                        </p>
                    </h1>
                     <a href="{{ route('dashboard.supplies.create') }}">
            ...
            @foreach ($supplies as $supply)
                ...
                <td class="py-4 px-6">
                    <form action="" method="POST">
                        @csrf
                        <input type="number" value="{{ $supply->quantity }}" name="quantity">
                        <input type="hidden" value="{{ $supply->id }}" name="id">
