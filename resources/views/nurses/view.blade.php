<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between p-6 bg-white border-b border-gray-200">
                    <h1 class="text-xl">
                        ...
                        {{ __('Total Count') }} : {{ $nurses->count() }}
                        </p>
                    </h1>
                    @if (auth()->user()->hasPermissionTo('Add nurse'))
                        <a href="{{ route('dashboard.nurses.create') }}">
        ...
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="py-3 px-6">
                    ...
                    @endif
                    @if (auth()->user()->hasPermissionTo('Delete nurse'))
    ...
    <div class="py-4 px-8">
    @if(method_exists($nurses, 'links'))
        {{ $nurses->appends(Request::except(['page','_token']))->links() }}
    @endif
    </div>
</div>
